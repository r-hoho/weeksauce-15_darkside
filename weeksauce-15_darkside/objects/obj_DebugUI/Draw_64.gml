...
draw_text(10,100,"p1: "+ string(global.p1_state));
draw_text(10,120,"p2: "+ string(global.p2_state));
draw_text(10,140,"p3: "+ string(global.p3_state));
draw_text(10,160,"p4: "+ string(global.p4_state));
